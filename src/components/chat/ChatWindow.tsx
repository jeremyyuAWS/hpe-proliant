      ...
      <div className="border-b border-gray-200 p-4 bg-gradient-to-r from-[#0F2027] to-[#203A43] text-white">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="font-semibold">HPE AI Research Assistant</h2>
              <div className="flex items-center space-x-2 text-sm">
                <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                <span className="text-green-200">
                  {isTyping ? 'Researching...' : 'Online'}
                </span>
                {activityData.sourceCount > 0 && (
                  <>
                    <div className="w-1 h-1 bg-gray-400 rounded-full"></div>
                    <span className="text-gray-300">{activityData.sourceCount} sources</span>
                  </>
                )}
              </div>
            </div>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        {messages.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-gray-600 mb-2">Ready to help!</h3>
            <p className="text-gray-500">Ask me anything about technology trends, market analysis, or strategic guidance.</p>
          </div>
        ) : (
